...
guids = {
    "Idle": "4100000000000000a0b77823fca88d01",
    "Run": "4100000000000000a0b77823fca88d02",
    "Attack": "4100000000000000a0b77823fca88d03",
    "Dash": "4100000000000000a0b77823fca88d04",
    "Dead": "4100000000000000a0b77823fca88d05"
}
...
for action in ACTIONS:
    png_name = f"ThanhDong-{action}.png"
    ...
    for i in range(8):
        s_name = f"ThanhDong-{action}_{i}"
        internal_id = 4100000000 + (ACTIONS.index(action) * 100000) + (i * 12345)
