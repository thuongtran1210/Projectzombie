...
SRC_PATH = r"C:\Users\thuon\.gemini\antigravity-ide\brain\879351c2-8af8-40a9-84a5-fef3c5ecce1a\.user_uploaded\media_1787805139446.png"
dst_dir = r"c:\Users\thuon\Unity\Projectzombie\Assets\Art\Skills"
os.makedirs(dst_dir, exist_ok=True)
dst_path = os.path.join(dst_dir, "Tex_AnSi_EarthImpactSlash.png")
...
print(f"Processed An Si Earth Impact Slash to: {dst_path}")
