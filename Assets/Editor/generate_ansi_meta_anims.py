...
ACTIONS = ["Idle", "Run", "Attack", "Dash", "Dead"]

guids = {
    "Idle": "3200000000000000a0b77823fca88d01",
    "Run": "3200000000000000a0b77823fca88d02",
    "Attack": "3200000000000000a0b77823fca88d03",
    "Dash": "3200000000000000a0b77823fca88d04",
    "Dead": "3200000000000000a0b77823fca88d05"
}
...
for action in ACTIONS:
    ...
    for i in range(frame_cnt):
        s_name = f"AnSi-{action}_{i}"
        internal_id = 3200000000 + (ACTIONS.index(action) * 100000) + (i * 12345)
    ...
    meta_content = (
        ...
        "    physicsShape: []\n"
        "    bones: []\n"
        "    spriteID: 5e97eb03825dee720800000000000009\n"
        "    internalID: 0\n"
        "    vertices: []\n"
        "    indices: \n"
        "    edges: []\n"
