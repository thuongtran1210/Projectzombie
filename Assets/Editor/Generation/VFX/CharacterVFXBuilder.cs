...
namespace ProjectZombie.Editor.VFX
{
    public static class CharacterVFXBuilder
    {
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/1. Build Thu Sinh Ink Slash VFX", false, 30)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/2. Build Dao Si Sword Slash VFX", false, 31)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/3. Build Thanh Dong Air Wave VFX", false, 32)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/4. Build An Si Earth Impact Slash VFX", false, 33)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/5. Auto Assign Character Attack Icons", false, 34)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Character Attacks/0. Build All 4 Character Basic Attack VFX (1-Click)", false, 29)]
