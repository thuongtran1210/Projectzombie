...
namespace ProjectZombie.Editor.VFX
{
    ...
    public static class SlapstickRelicVFXBuilder
    {
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Slapstick Relics/1. 🩴 Build W_SLIPPER (Dép Tổ Ong)", false, 21)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Slapstick Relics/2. 🍚 Build W_POT (Nồi Cơm Thạch Sanh)", false, 22)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Slapstick Relics/3. 💨 Build W_PIPE (Điếu Cày Thuốc Lào)", false, 23)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Slapstick Relics/4. 🎋 Build W_MAT (Chiếu Cói)", false, 24)]
        ...
        [MenuItem("ProjectZombie/1. 🛠️ Editor & Content/VFX/Slapstick Relics/5. 🪶 Build W_BROOM (Chổi Lông Gà)", false, 25)]
