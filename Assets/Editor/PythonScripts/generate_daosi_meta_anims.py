...
guids = {
    "Idle": "3100000000000000a0b77823fca88d01",
    "Run": "3100000000000000a0b77823fca88d02",
    "Attack": "3100000000000000a0b77823fca88d03",
    "Dash": "3100000000000000a0b77823fca88d04",
    "Dead": "3100000000000000a0b77823fca88d05"
}
...
for action in ACTIONS:
    ...
    for i in range(6):
        s_name = f"DaoSi-{action}_{i}"
        internal_id = 3100000000 + (ACTIONS.index(action) * 100000) + (i * 12345)
    ...
    meta_content = (
        ...
        "    physicsShape: []\n"
        "    bones: []\n"
        "    spriteID: 5e97eb03825dee720800000000000005\n"
        "    internalID: 0\n"
        "    vertices: []\n"
        "    indices: \n"
        "    edges: []\n"
