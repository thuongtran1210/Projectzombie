...
guids = {
    "Idle": "2100000000000000a0b77823fca88d01",
    "Run": "2100000000000000a0b77823fca88d02",
    "Attack": "2100000000000000a0b77823fca88d03",
    "Dash": "2100000000000000a0b77823fca88d04",
    "Dead": "2100000000000000a0b77823fca88d05"
}
...
for action in ACTIONS:
    ...
    for i in range(6):
        s_name = f"ThuSinh-{action}_{i}"
        internal_id = 2100000000 + (ACTIONS.index(action) * 100000) + (i * 12345)
    ...
    meta_content = (
        ...
        "    physicsShape: []\n"
        "    bones: []\n"
        "    spriteID: 5e97eb03825dee720800000000000007\n"
        "    internalID: 0\n"
        "    vertices: []\n"
        "    indices: \n"
        "    edges: []\n"
