...
namespace ProjectZombie.EditorTools
{
    ...
    {
        [MenuItem("Tools/ProjectZombie/UI/🛡️ Gắn Safe Zone Trong Trận (An Toàn 100% - Không Đè UI)", priority = 15)]
        ...
        [MenuItem("Tools/ProjectZombie/UI/Trong Trận (In-Game Gameplay)/🛡️ Gắn Safe Zone Cho Top HUD (Máu, Cấp, Timer)", priority = 20)]
        ...
        [MenuItem("Tools/ProjectZombie/UI/Trong Trận (In-Game Gameplay)/🛡️ Gắn Safe Zone Cho Mobile Controls (Joystick & Nút)", priority = 22)]
