...
guids = {
    "Idle": "7100000000000000a0b77823fca88d01",
    "Run": "7100000000000000a0b77823fca88d02",
    "Attack": "7100000000000000a0b77823fca88d03",
    "Dead": "7100000000000000a0b77823fca88d04"
}
...
for action in ACTIONS:
    ...
    for i in range(6):
        s_name = f"Madoino-{action}_{i}"
        internal_id = 7100000000 + (ACTIONS.index(action) * 100000) + (i * 12345)
    ...
    meta_content = (
        ...
        "    physicsShape: []\n"
        "    bones: []\n"
        "    spriteID: 5e97eb03825dee72080000000000000b\n"
        "    internalID: 0\n"
        "    vertices: []\n"
        "    indices: \n"
        "    edges: []\n"
